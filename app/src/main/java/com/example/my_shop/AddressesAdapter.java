...
import static com.example.my_shop.MyAccountFragment.MANAGE_ADDRESS;
import static com.example.my_shop.MyAddressesActivity.refreshItem;
    ...
    public class Viewholder extends RecyclerView.ViewHolder {
        ...
        private void setData(String username, String userAddress, String userPincode, Boolean selected, final int position){
            ...
            if (MODE == SELECT_ADDRESS){
                ...
                icon.setImageResource(R.mipmap.threedot);
